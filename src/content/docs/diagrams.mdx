...
The boundary drawn explicitly. Evidence from delivery *may reveal* a Product Change. The dashed return path represents learning, not an automatic obligation. Authoritative: [the specification](/spec/).
