...
<CardGrid stagger>
  ...
  <Card title="The reference implementation" icon="github">
    ...
    implements the citation contract and currently targets the v0.1 profile:
